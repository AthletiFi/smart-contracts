...
def process_folders():
    ...
    "Anderson Rodriguez": "Anderson Rodriguez from Villanova Soccer Academy. They are an indispensable asset to the 2009s team. with the number 6 on the back, their dedication to the game is palpable.",
    "Andrew Gilmore": "Andrew Gilmore from Villanova Soccer Academy. Recognized as one of the pillars of the 2011s team, with the number 2 on the back, the spirit and values of the sport are manifested in every play.",
    ...
    "Colin Bobrek": "Colin Bobrek from Villanova Soccer Academy. Standing out, they're a core player for the 2011s side. with the number 16 on the back, their dedication to the game is palpable.",
    ...
    "Jude Ibrahim": "Jude Ibrahim from Villanova Soccer Academy. they've cemented a spot as a remarkable player in the 2009s lineup. with the number 10 on the back, their enthusiasm for soccer is evident every match.",
    "Luke Lavelle": "Luke Lavelle from Villanova Soccer Academy. Standing out, they're a core player for the 2011s side. with the number 24 on the back, they consistently play with heart, radiating the true essence of soccer.",
    ...
    "Nacho Aliaga": "Nacho Aliaga  from Villanova Soccer Academy. Recognized as one of the pillars of the 2011s team, with the number 13 on the back, their dedication to the game is palpable.",
    ...
    "Nickollas Nascimento": "Nickollas Nascimento  from Villanova Soccer Academy. they've cemented a spot as a remarkable player in the 2011s lineup. with the number 9 on the back, they consistently play with heart, radiating the true essence of soccer.",
    ...
    "Salvador Carrillo": "Salvador Carrillo from Villanova Soccer Academy. Standing out, they're a core player for the 2009s side. with the number 22 on the back, they consistently play with heart, radiating the true essence of soccer.",
